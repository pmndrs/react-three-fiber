...
describe('ReactThreeTestRenderer', () => {
        ...
        children: [
          {
            type: 'Mesh',
            children: [
              { type: 'BoxBufferGeometry', children: null },
              { type: 'MeshBasicMaterial', children: null },
            ],
          },
        ],
      },
  ...
  //   const renderer = ReactTestRenderer.create([<Component key="a">Hi</Component>, <Component key="b">Bye</Component>])
