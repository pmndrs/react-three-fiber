/**
 * Typecheck-only regression for #3898: importing `@react-three/fiber/webgpu` must not break JSX whose tag is a
 * `React.ElementType`.
 *
...
import { Canvas, type ThreeElements } from '../../packages/fiber/dist/webgpu/index'
