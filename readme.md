...
Build dynamic scene graphs declaratively, with re-usable components that react to state changes and can respond to interactions out of the box. A component model will bring order and santiy to your codebase and will make handling Threejs easier.
