/**
 * @fileoverview Native Canvas component for React Native
 *
 * Provides a Three.js canvas that works with React Native using expo-gl
 * or other pluggable GL context providers.
 */
...
function CanvasImpl({
  ...
  // Get pluggable GL context
  const { GLView, contextType } = useGLContext()
