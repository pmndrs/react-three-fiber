/**
 * The `ReactThreeFiber` namespace of the WebGPU entry: the shared element types plus this entry's JSX map.
 *
...
export type { ThreeElements, ThreeExports } from '../../src/webgpu/index'
