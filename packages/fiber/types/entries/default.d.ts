/**
 * The `ReactThreeFiber` namespace of the default entry: the shared element types plus this entry's JSX map.
 *
...
export type { ThreeElements, ThreeExports } from '../../src/index'
