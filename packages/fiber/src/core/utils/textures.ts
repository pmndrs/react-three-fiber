...
// NOTE: intentionally NOT re-exported from ./index — the default and legacy entries don't expose
// these. The webgpu entry re-exports createTextureOperations from src/webgpu/hooks/index.ts.
