...
> [!NOTE]
> This applies to GLSL `ShaderMaterial` on the WebGL backend. TSL node materials on WebGPU declare their uniforms with the [TSL hooks](/webgpu/tsl-hooks) instead.
