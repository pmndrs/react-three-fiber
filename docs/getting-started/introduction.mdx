...
> [!NOTE]
> **v10 is in alpha**, bringing WebGPU support and a new frame-loop scheduler. Preview its docs [here](https://docs.pmnd.rs/react-three-fiber/next/getting-started/introduction), or with the version picker at the bottom right of every page.
