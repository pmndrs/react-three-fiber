...
<Grid cols={3}>
  <li>
    ...
    [<Img src="./community-r3f-components-images/3dtilesrendererjs-header-mars.png" alt="3DTilesRendererJS r3f demo" className="aspect-[16/9] object-cover" width="1763" height="926" />](https://nasa-ammos.github.io/3DTilesRendererJS/r3f/basic.html)
  </li>
  ...
  <li>
    ...
    [<Img src="./community-r3f-components-images/threepipe-editor-2.webp" alt="threepipe r3f plugin preview" className="aspect-[16/9] object-cover" />](https://threepipe.org/examples/tweakpane-editor/)
  </li>

  <li>
    [react-three-map](https://github.com/RodrigoHamuy/react-three-map)

    [<Img src="./community-r3f-components-images/react-three-map-coordinates.png" alt="react-three-map demo" className="aspect-[16/9] object-cover" />](https://rodrigohamuy.github.io/react-three-map/?story=buildings-3d--default&theme=dark)
  </li>

  <li>
    [Farazz/CustomShaderMaterial](https://github.com/FarazzShaikh/THREE-CustomShaderMaterial)

    [<Img src="./community-r3f-components-images/CustomShaderMaterial-waves-demo.png" alt="THREE-CustomShaderMaterial r3f demo" className="aspect-[16/9] object-cover" width="1763" height="926" />](https://farazzshaikh.github.io/THREE-CustomShaderMaterial/#/caustics)
  </li>
  ...
  <li>
    ...
    [<Img src="./community-r3f-components-images/r3f-scroll-rig.jpeg" alt="r3f-scroll-rig preview" className="aspect-[16/9] object-cover" />](https://codesandbox.io/p/sandbox/fu0ky6)
  ...
  <li>
    ...
    [<Img src="./community-r3f-components-images/r3f-globe-preview.png" alt="r3f-globe demo" className="aspect-[16/9] object-cover" />](https://vasturiano.github.io/r3f-globe/example/multiple-globes/)
  </li>
  ...
  <li>
    ...
    [<Img src="./community-r3f-components-images/R3F-Ultimate-Lens-Flare.png" alt="R3F-Ultimate-Lens-Flare demo" className="aspect-[16/9] object-cover" width="1763" height="926" />](https://ultimate-lens-flare.vercel.app/)
  </li>
