...
<Grid cols={3}>
  ...
  <li>
    [Takram three-geospatial clouds](https://github.com/takram-design-engineering/three-geospatial/tree/main/packages/clouds) doc
  ...
  <li>
    ...
    <Codesandbox id="c6m9lj" screenshot_url="https://www.theatrejs.com/images/docs/0.5/manual/studio/ui.png"/>
  </li>
  <li>
