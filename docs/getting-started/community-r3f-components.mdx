...
<Grid cols={3}>
  <li>
    ...
    [<img src="./community-r3f-components-images/3dtilesrendererjs-header-mars.jpg" alt="3DTilesRendererJS r3f demo" className="aspect-[16/9] object-cover" width="1763" height="926" />](https://nasa-ammos.github.io/3DTilesRendererJS/r3f/basic.html)
  </li>
  ...
  <li>
    [SparkJS](https://github.com/sparkjsdev/spark-react-r3f) 3DGS

    [<img src="./community-r3f-components-images/sparkjs-screen.jpg" alt="spark-react-r3f preview" className="aspect-[16/9] object-cover" />](https://sparkjs.dev/examples/#sogs)
  </li>

  <li>
    [threepipe plugin-r3f](https://threepipe.org/package/plugin-r3f.html#importing-and-setup)

    [<img src="./community-r3f-components-images//threepipe-editor-2.jpg" alt="threepipe r3f plugin preview" className="aspect-[16/9] object-cover" />](https://threepipe.org/examples/tweakpane-editor/)
  </li>

  <li>
    [react-three-map](https://github.com/RodrigoHamuy/react-three-map)

    [<img src="./community-r3f-components-images//react-three-map-coordinates.jpg" alt="react-three-map demo" className="aspect-[16/9] object-cover" />](https://rodrigohamuy.github.io/react-three-map/?story=buildings-3d--default&theme=dark)
  </li>

  <li>
    [Farazz/CustomShaderMaterial](https://github.com/FarazzShaikh/THREE-CustomShaderMaterial)

    [<img src="./community-r3f-components-images//CustomShaderMaterial-waves-demo.jpg" alt="THREE-CustomShaderMaterial r3f demo" className="aspect-[16/9] object-cover" width="1763" height="926" />](https://farazzshaikh.github.io/THREE-CustomShaderMaterial/#/caustics)
  </li>
  ...
  <li>
    ...
    <Codesandbox id="6xfrsv" screenshot_url="./community-r3f-components-images/theatrejs-ui.jpg" />
  </li>
  ...
  <li>
    ...
    <Codesandbox id="xzlmzz" screenshot_url="./community-r3f-components-images/LKG-cleopatra.jpg"/> 
  </li>
