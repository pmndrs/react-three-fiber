...
#### Stale
 - [Stale] [Theatre-js](https://github.com/theatre-js/theatre) repo and [doc](https://www.theatrejs.com/docs/latest) animation and keyframing
 - [Stale] Luma Labs [Gaussian Splats](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#react-three-fiber) renderer 
 - [Stale] [NYTimes/three-loader-3dtiles](https://nytimes.github.io/three-loader-3dtiles) 
 - [Stale] [Looking Glass](https://lfdocs.lookingglassfactory.com/software/creator-tools/webxr/react-three-fiber) 
...
<Grid cols={3}>
  <li>
    ...
    [<Img src="https://raw.githubusercontent.com/NASA-AMMOS/3DTilesRendererJS/master/images/header-mars.png" alt="3DTilesRendererJS r3f demo" className="aspect-[16/9] object-cover" width="1763" height="926" />](https://nasa-ammos.github.io/3DTilesRendererJS/r3f/basic.html)
  </li>
  ...
  <li>
    ...
    [<Img src="https://cgworld.jp/flashnews/Spark20-07.jpg" alt="spark-react-r3f preview" className="aspect-[16/9] object-cover" />](https://sparkjs.dev/examples/#sogs)
  </li>

  <li>
    [threepipe plugin-r3f](https://threepipe.org/package/plugin-r3f.html#importing-and-setup)

    [<Img src="https://raw.githubusercontent.com/repalash/threepipe/refs/heads/master/website/public/images/editor-edit.webp" alt="threepipe r3f plugin preview" className="aspect-[16/9] object-cover" />](https://threepipe.org/examples/tweakpane-editor/)
  </li>

  <li>
    [react-three-map](https://github.com/RodrigoHamuy/react-three-map)

    [<Img src="https://raw.githubusercontent.com/RodrigoHamuy/react-three-map/refs/heads/main/docs/coordinates.png" alt="react-three-map demo" className="aspect-[16/9] object-cover" />](https://rodrigohamuy.github.io/react-three-map/?story=buildings-3d--default&theme=dark)
  </li>
  ...
  <li>
    ...
    [<Img src="https://assets.wawasensei.dev/react-three-fiber/vfx-engine/wawa-vfx-preview.jpg?v=2" alt="wawa-vfx preview" className="aspect-[16/9] object-cover" />](https://wawa-vfx.wawasensei.dev/)
  </li>

  <li>
    [mustache-dev/Three-VFX](https://github.com/mustache-dev/Three-VFX)

    [<Img src="https://pbs.twimg.com/media/HBw0pCxW0AAZy4d?format=jpg&name=4096x4096" alt="Three-VFX preview" className="aspect-[16/9] object-cover" />](https://three-vfx.vercel.app/)
  </li>

  <li>
    [14islands/r3f-scroll-rig](https://github.com/14islands/r3f-scroll-rig)
    [<Img src="https://user-images.githubusercontent.com/420472/191715313-cc813f47-4e4a-454f-a2f5-d8e2ec998c95.jpeg" alt="r3f-scroll-rig preview" className="aspect-[16/9] object-cover" />](https://codesandbox.io/p/sandbox/fu0ky6)
  ...
  <li>
    ...
    [<Img src="https://raw.githubusercontent.com/vasturiano/r3f-globe/master/example/preview.png" alt="r3f-globe demo" className="aspect-[16/9] object-cover" />](https://vasturiano.github.io/r3f-globe/example/multiple-globes/)
  </li>
