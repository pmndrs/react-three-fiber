...
- **[Build](./BUILD.md)** — Entry points, the shared core, renderer supports, and how the bundles are produced.
...
- **Entry points, the shared core and renderer supports** — [BUILD.md](./BUILD.md).
