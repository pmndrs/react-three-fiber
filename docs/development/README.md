...
- **[Build](./BUILD.md)** — Entry points, the shared core chunk, the renderer provider, and how the bundles are produced.
...
- **Entry points, the shared core chunk and the renderer provider** — [BUILD.md](./BUILD.md).
