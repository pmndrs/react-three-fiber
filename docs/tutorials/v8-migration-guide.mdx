...
See [installation](/getting-started/installation#react-native) to get started with managed Expo or bare React Native apps.
...
This is complete with support for Pressability events and native threejs loaders. See [events](/api/events) for a complete list of events.
